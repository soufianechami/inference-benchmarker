...
docker run --rm \
  ...
  --url "${SAMBANOVA_URL:-https://api-sambastack-dev-2.sambanova.net}" \
  --api-key "${SAMBANOVA_API_KEY}" \
  --tokenizer-name openai/gpt-oss-120b \
  --model-name gpt-oss-120b \
  --dataset-file classification.json \
  --benchmark-kind rate \
  -r 0.2 -r 0.5 -r 1.0 -r 1.5 -r 2.0 -r 2.5 -r 3.0 -r 3.5 -r 4.0 -r 4.5 -r 5.0 -r 5.5 -r 6.0 -r 6.5 -r 7.0 -r 7.5 -r 8.0 -r 8.5 -r 9.0 -r 9.5 -r 10.0 \
  --warmup 60s \
  --max-vus 2000 \
  --run-id gpt-oss-120b-10_1_profile \
