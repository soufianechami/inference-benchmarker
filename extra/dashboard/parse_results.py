...
def build_results(results_dir, results_file, device):
    ...
    # Per-request speed: decoded tokens per request / avg E2E latency in seconds time_to_first_token_ms
    df['per_request_speed'] = df['decoded_tokens'] / ((df['e2e_latency_ms_avg']-df['time_to_first_token_ms_avg'])/ 1000.0)
